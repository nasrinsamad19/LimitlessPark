            ...
            bottom: PreferredSize(
              ...
              child: ColoredBox(
                ...
                child: TabBar(
                  ...
                  indicatorWeight: 5,
                  tabs: [
                    Tab(child:Text('Book Now', style: TextStyle(
                        color: Colors.black,
                        fontSize: 14.0),),),
                    Tab(child: Text('Activities', style: TextStyle(
                        color: Colors.black,
                        fontSize: 14.0),),),
                    Tab(child: Text('Profile', style: TextStyle(
                        color: Colors.black,
                        fontSize: 14.0),),),
            ...
            title: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Limitless Parking'.toUpperCase(),
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 19.0),
                  ),
